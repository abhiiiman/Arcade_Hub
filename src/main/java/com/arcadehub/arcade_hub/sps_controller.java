...
//            singleMode.setEffect(bloom);
            singleMode.setImage(new Image("C:\\Users\\DELL\\IdeaProjects\\Arcade_Hub\\src\\main\\resources\\com\\arcadehub\\arcade_hub_imgs\\singleButtonHover1.png"));
        });
        multiMode.setOnMouseEntered(event -> {
            // Set the bloom effect to the button
//            multiMode.setEffect(bloom);
            multiMode.setImage(new Image("C:\\Users\\DELL\\IdeaProjects\\Arcade_Hub\\src\\main\\resources\\com\\arcadehub\\arcade_hub_imgs\\multiButtonHover1.png"));
        });
        historyMode.setOnMouseEntered(event -> {
            // Set the bloom effect to the button
//            historyMode.setEffect(bloom);
            historyMode.setImage(new Image("C:\\Users\\DELL\\IdeaProjects\\Arcade_Hub\\src\\main\\resources\\com\\arcadehub\\arcade_hub_imgs\\gameHistoryHover1.png"));
        });
